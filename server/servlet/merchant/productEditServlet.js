...
exports.productEditServlet = async (req, res) => {
  const { body } = req;
  ...
  const json = await productService.edit(user, productId, sku, name, description, quantity, price, taxable, brandId, categoryIds);  
